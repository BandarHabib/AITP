  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: BlocBuilder<GetLandmarkBloc, GetLandmarkState>(
          builder: (context, state) {
                            ...
                            Padding(
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  ...
                                  Container(
                                      // decoration: BoxDecoration(
                                      //     color: state.results[i].expenses == 1
                                      //         ? Colors.green.withOpacity(0.3)
                                      //         : state.results[i].expenses == 2
                            ...
                            Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  child: Text(
                                    'score: ${state.results[i].confidence} latitude: ${state.results[i].latitude} longitude: ${state.results[i].longitude}',
                                    style: TextStyle(
                                      fontSize: 10,
            ...
            } else if (state is LandmarkProcessing) {
              return Center(
